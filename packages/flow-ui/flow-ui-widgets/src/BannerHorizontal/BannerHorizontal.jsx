    ...
    <Flex sx={styles.wrapper(banner && banner.src)}>
      <Box sx={styles.left}>
        <Heading variant='h3' sx={styles.heading}>
          Shop Ngọc Ngân xin chào quý khách hàng
        </Heading>
        <Text sx={styles.subheading}>Chúc Anh/Chị năm mới vui vẻ.</Text>
      </Box>
      <Box sx={styles.right}>
        <Button as={Link} to='/shop' variant='primary' aria-label='Download Report'>
          Ủng Hộ Shop
        </Button>
      </Box>
    </Flex>
